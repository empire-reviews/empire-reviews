...
export default function SettingsPage() {
    ...
    useEffect(() => {
        ...
        setIsDirty(true);
    }, [publishMode, emailAlerts, themeColor, widgetBgColor, starColor, borderRadius, reviewRequestDelay, physicalAddress, senderEmail, flowEnabled, klaviyoEnabled, klaviyoKey, googleShoppingEnabled, aiProvider, aiApiKey, language]);
