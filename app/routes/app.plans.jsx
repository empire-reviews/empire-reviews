...
export default function PlansPage() {
    ...
    return (<Page fullWidth>
            ...
            <div className="zenith-vault">
                ...
                <div className="zenith-slabs">
                    ...
                    <div className="zenith-slab">
                        ...
                        <button className={`zenith-btn btn-starter ${isPro ? '' : 'btn-disabled'}`} disabled={!isPro}>
                    ...
                    <div className="zenith-slab slab-pro">
                        ...
                        <button className={`zenith-btn btn-pro ${isPro ? 'btn-disabled' : ''}`} onClick={handleUpgrade} disabled={isPro}>
                            {isPro ? "Zenith Active" : "Level Up to Pro ⚡"}
                        </button>

                        <div style={{ textAlign: "center", marginTop: "1rem" }}>
                            <button onClick={() => setReferralOpen(true)} style={{ background: 'transparent', border: 'none', cursor: 'pointer', padding: 0 }}>
            ...
            {referralOpen && (<div className="vip-overlay" onClick={() => setReferralOpen(false)}>
                    <div className="vip-modal" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="vip-input-wrap">
                            ...
                            <input type="text" className="vip-input" value={referralCode} onChange={(e) => setReferralCode(e.target.value)} placeholder="Enter your code..." autoComplete="off" onKeyDown={(e) => e.key === 'Enter' && handleReferralSubmit()}/>
                        </div>

                        <button className="vip-submit" onClick={handleReferralSubmit} disabled={fetcher.state === "submitting" || !referralCode.trim()}>
...
function SpecRow({ label, starter, pro, isProVal }) {
    return (<div className="spec-row">
...
function FeatureItem({ text, active }) {
    return (<div className={`feature-item ${active ? 'active' : ''}`}>
