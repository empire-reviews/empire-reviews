...
export const action = async ({ request }) => {
    ...
    try {
        ...
        const customerName = formData.get("author") || "Anonymous";
        const customerEmail = formData.get("email");
        const title = formData.get("title");
        const mediaUrls = formData.get("media_urls"); // Expecting comma-separated URLs
        ...
        if (settings?.enableFlow) {
            ...
            try {
                ...
                if (session) {
                    ...
                    await client.request(`mutation flowTriggerReceive($handle: String!, $payload: JSON!, $surreal: Boolean) {
...
export const loader = async ({ request }) => {
    ...
    try {
        const where = {}; // Build dynamic query
